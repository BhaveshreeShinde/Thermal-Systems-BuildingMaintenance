...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/services/building-maintenance" element={<BuildingMaintenance />}></Route>
      <Route path="/services/24-hour-emergency-service" element={<EmergencyService />}></Route>
      <Route path="/services/commercial-roofing-maintenance-repairs" element={<CommercialRoofing />}></Route>
      <Route path="/services/tenant-and-mechanical-upgrades" element={<RoofTopRepair />}></Route>
      <Route path="/services/commercial-re-roofing" element={<CommercialReRoofing />}></Route>
      <Route path="/services/commercial-wall-systems" element={<CommercialWall />}></Route>
      <Route path="/TrustThermalSystems" element={<TrustThermalSystems />}></Route>
      <Route path="/FlatRoofRepairAirdrie" element={<FlatRoofRepairAirdrie />}></Route>
      <Route path="/CommercialCladdingRepairCalgary" element={<CommercialCladdingRepairCalgary />}></Route>
